...
class ConferenceController
{
    ...
    public function RegisterAction()
    {
        try{
            ...
            if($result != NULL){
                $encrypted = $this->safeEncrypt(strval($result), $GLOBALS['configs']['secret_key']);
    ...
    public function UpdateAction()
    {
        try{
            ...
            $id = $this->safeDecrypt($_POST['id'], $GLOBALS['configs']['secret_key']);
            unset($_POST['id']);
            unset($_POST['file']);
    ...
    private function getId(){
        ...
        $decrypted = $this->safeDecrypt($encrypted, $GLOBALS['configs']['secret_key']);
