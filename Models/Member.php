...
class Member
{
    ...
    {
        $pdo = new PDO("mysql:host={$GLOBALS['configs']['host']};dbname={$GLOBALS['configs']['dbname']}", $GLOBALS['configs']['username'], $GLOBALS['configs']['password']);
    ...
    public static function getMembers()
    {
        ...
        foreach ($result as $value) {
            if($value->photo != NULL){
                $value->photo = $GLOBALS['configs']['img_base_url'].$value->photo;
            }
            else{
                $value->photo = $GLOBALS['configs']['img_base_url'].'default.png';
            }
        }
        return $result;
    }
